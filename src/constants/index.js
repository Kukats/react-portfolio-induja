...
export const HERO_CONTENT = `Senior Business Analyst and Data Analyst with 4+ years of experience transforming complex data into clear, actionable insights. I have worked across consulting, regulated utilities, research, and digital services, partnering closely with business and technical teams to design SQL-driven reporting frameworks, build BI dashboards, and automate manual processes to improve decision making. My core skill set includes SQL, Power BI, Tableau, Python, R, and cloud data platforms, and I enjoy owning problems end to end from data extraction and validation to analysis, visualization, and stakeholder-ready insights.`;
